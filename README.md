...
- [Restaurants](https://www.exploretock.com/restaurants)
...
- Ticketed Experiences (chef's tables, tastings, events)
- Takeout and Delivery (including wine and retail)
- Marketplace Discovery (exploretock.com)
- Guest CRM
- Operations and Floor Management

## Use Cases
- Fine dining reservations with prepayment
...
## Integrations
- Point of Sale (POS), CRM, Marketing, Loyalty, Payments
- American Express (parent; dining benefits)
- Squarespace (legacy 2021-2024)
